...
type PostAdminJSONBody = UserRequest

// PostEditionJSONBody defines parameters for PostEdition.
type PostEditionJSONBody = NewEdition

// PostEditionAuthorizeJSONBody defines parameters for PostEditionAuthorize.
type PostEditionAuthorizeJSONBody = EditionAuthorizeRequest

// PatchEditionJSONBody defines parameters for PatchEdition.
type PatchEditionJSONBody = PatchEdition

// PostEditionGameJSONBody defines parameters for PostEditionGame.
type PostEditionGameJSONBody = PatchEditionGameRequest
...
type PostGameJSONBody = NewGame

// PatchGameJSONBody defines parameters for PatchGame.
type PatchGameJSONBody = PatchGame

// PatchGameRoleJSONBody defines parameters for PatchGameRole.
type PatchGameRoleJSONBody = GameRoleRequest
...
// PostGameVersionJSONBody defines parameters for PostGameVersion.
type PostGameVersionJSONBody = NewGameVersion
...
// PostSeatJSONBody defines parameters for PostSeat.
type PostSeatJSONBody = PostSeatRequest

// PatchSeatStatusJSONBody defines parameters for PatchSeatStatus.
type PatchSeatStatusJSONBody = PatchSeatStatusRequest
