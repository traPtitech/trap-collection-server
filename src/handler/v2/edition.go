...
func (edition *Edition) PostEdition(c echo.Context) error {
	...
	var optionQuestionnaireURL types.Option[values.EditionQuestionnaireURL]
	if req.Questionnaire != nil {
		...
		optionQuestionnaireURL = types.NewOption(values.NewEditionQuestionnaireURL(urlValue))
	}
